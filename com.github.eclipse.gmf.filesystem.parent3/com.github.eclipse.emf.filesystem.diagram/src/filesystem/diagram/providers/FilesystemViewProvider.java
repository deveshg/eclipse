...
public class FilesystemViewProvider extends AbstractProvider implements
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		switch (visualID) {
		case FileEditPart.VISUAL_ID:
			return createFile_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		case FolderEditPart.VISUAL_ID:
			return createFolder_2001(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createFile_2002(EObject domainElement, View containerView,
	 ...
	 * @generated
	 */
	public Node createFolder_2001(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
