...
public class FilesystemElementTypes {
	 ...
	 * @generated
	 */
	public static final IElementType File_2002 = getElementType("com.github.eclipse.emf.filesystem.diagram.File_2002"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType Folder_2001 = getElementType("com.github.eclipse.emf.filesystem.diagram.Folder_2001"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType FolderFolders_4002 = getElementType("com.github.eclipse.emf.filesystem.diagram.FolderFolders_4002"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType FolderFiles_4001 = getElementType("com.github.eclipse.emf.filesystem.diagram.FolderFiles_4001"); //$NON-NLS-1$
	...
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(FolderFolders_4002,
					FilesystemPackage.eINSTANCE.getFolder_Folders());

			elements.put(FolderFiles_4001,
