package mathExpr.diagram.application;
...
public class DiagramEditorActionBarAdvisor extends ActionBarAdvisor {
	...
	protected void fillMenuBar(IMenuManager menu) {

		{
			IMenuManager menuX = new MenuManager(
					mathExpr.diagram.part.Messages.ApplicationMenuName_File,
...

			{
				IMenuManager menuXX = new MenuManager(
						mathExpr.diagram.part.Messages.ApplicationMenuName_New,
						"new");
		...
		{
			IMenuManager menuX = new MenuManager(
					mathExpr.diagram.part.Messages.ApplicationMenuName_Edit,
		...
		{
			IMenuManager menuX = new MenuManager(
					mathExpr.diagram.part.Messages.ApplicationMenuName_Window,
		...
		{
			IMenuManager menuX = new MenuManager(
					mathExpr.diagram.part.Messages.ApplicationMenuName_Help,
		...
		if (editorDescriptor == null) {
			MessageDialog
					.openError(
							...
							mathExpr.diagram.part.Messages.DiagramEditorActionBarAdvisor_DefaultFileEditorTitle,
							NLS.bind(
									mathExpr.diagram.part.Messages.DiagramEditorActionBarAdvisor_DefaultFileEditorMessage,
			...
			try {
				...
				MessageDialog
						.openError(
								workbenchWindow.getShell(),
								mathExpr.diagram.part.Messages.DiagramEditorActionBarAdvisor_DefaultEditorOpenErrorTitle,
	...
	public static class NewDiagramAction extends WorkbenchWindowActionDelegate {
		...
		public void run(IAction action) {
			mathExpr.diagram.part.MathExprCreationWizard wizard = new mathExpr.diagram.part.MathExprCreationWizard();
	...
	public static class AboutAction extends WorkbenchWindowActionDelegate {
		...
		public void run(IAction action) {
			MessageDialog
					.openInformation(
							getWindow().getShell(),
							mathExpr.diagram.part.Messages.DiagramEditorActionBarAdvisor_AboutDialogTitle,
							mathExpr.diagram.part.Messages.DiagramEditorActionBarAdvisor_AboutDialogMessage);
		}
	}
