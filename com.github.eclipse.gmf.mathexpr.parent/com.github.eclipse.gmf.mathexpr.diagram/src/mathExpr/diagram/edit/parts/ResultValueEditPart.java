...
public class ResultValueEditPart extends CompartmentEditPart implements
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new mathExpr.diagram.edit.policies.MathExprTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = mathExpr.diagram.providers.MathExprParserProvider
					.getParser(
							mathExpr.diagram.providers.MathExprElementTypes.Result_2004,
							getParserElement(),
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					mathExpr.diagram.edit.parts.MathExprEditPartFactory
