 ...
 * @generated
 */
public class MathExprDiagramEditorUtil {
	...
	public static boolean openDiagram(Resource diagram)
		...
		page.openEditor(new URIEditorInput(diagram.getURI()),
				mathExpr.diagram.part.MathExprDiagramEditor.ID);
		return true;
	}
	...
	public static Resource openModel(Shell shell, String description,
		...
		try {
			...
			MessageDialog
					.openError(
							shell,
							mathExpr.diagram.part.Messages.MathExprDiagramEditorUtil_OpenModelResourceErrorDialogTitle,
							NLS.bind(
									mathExpr.diagram.part.Messages.MathExprDiagramEditorUtil_OpenModelResourceErrorDialogMessage,
									fileName));
		}
		return resource;
	}
	...
	public static void runWizard(Shell shell, Wizard wizard, String settingsKey) {
		IDialogSettings pluginDialogSettings = mathExpr.diagram.part.MathExprDiagramEditorPlugin
	...
	public static Resource createDiagram(URI diagramURI, URI modelURI,
		...
		progressMonitor
				.beginTask(
						mathExpr.diagram.part.Messages.MathExprDiagramEditorUtil_CreateDiagramProgressTask,
						3);
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
				editingDomain,
				mathExpr.diagram.part.Messages.MathExprDiagramEditorUtil_CreateDiagramCommandLabel,
				Collections.EMPTY_LIST) {
			protected CommandResult doExecuteWithResult(
					IProgressMonitor monitor, IAdaptable info)
					throws ExecutionException {
				mathExpr.MathDiagram model = createInitialModel();
	 ...
	 * @generated
	 */
	private static mathExpr.MathDiagram createInitialModel() {
		return mathExpr.MathExprFactory.eINSTANCE.createMathDiagram();
	}
	 ...
	 * @generated
	 */
	private static void attachModelToResource(mathExpr.MathDiagram model,
			Resource resource) {
