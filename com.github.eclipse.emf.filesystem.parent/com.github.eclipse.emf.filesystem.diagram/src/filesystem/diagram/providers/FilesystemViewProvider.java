...
public class FilesystemViewProvider extends AbstractProvider implements
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case FolderFoldersEditPart.VISUAL_ID:
			return createFolderFolders_4001(containerView, index, persisted,
					preferencesHint);
		case FolderFilesEditPart.VISUAL_ID:
			return createFolderFiles_4002(containerView, index, persisted,
					preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Edge createFolderFolders_4001(View containerView, int index,
	 ...
	 * @generated
	 */
	public Edge createFolderFiles_4002(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
